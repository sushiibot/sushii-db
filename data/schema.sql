...
--
-- Name: update_user_xp(bigint, bigint, bigint); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.update_user_xp(guild_id bigint, channel_id bigint, user_id bigint) RETURNS app_public.user_xp_update_result
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'app_public', 'pg_temp'
    AS $_$
...
--
-- Name: FUNCTION update_user_xp(guild_id bigint, channel_id bigint, user_id bigint); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.update_user_xp(guild_id bigint, channel_id bigint, user_id bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.update_user_xp(guild_id bigint, channel_id bigint, user_id bigint) TO sushii_visitor;
GRANT ALL ON FUNCTION app_public.update_user_xp(guild_id bigint, channel_id bigint, user_id bigint) TO sushii_admin;
